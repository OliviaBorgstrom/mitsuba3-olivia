...
class PhotonEmitterOlivia final : public Emitter<Float, Spectrum> {
public:
    MI_IMPORT_BASE(Emitter, m_flags, m_medium, m_to_world)
    MI_IMPORT_TYPES(Scene, Texture)

    PhotonEmitterOlivia(const Properties &props) : Base(props) {
    ...
    std::string to_string() const override {
        ...
        oss << "PhotonEmitterOlivia[" << std::endl
...
MI_IMPLEMENT_CLASS_VARIANT(PhotonEmitterOlivia, Emitter)
MI_EXPORT_PLUGIN(PhotonEmitterOlivia, "Spot emitter")
